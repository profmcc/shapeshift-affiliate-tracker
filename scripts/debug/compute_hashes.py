...
increase_liquidity_sig = (
    "IncreaseLiquidity(address,int24,int24,uint128,uint256,uint256)"
)
decrease_liquidity_sig = (
    "DecreaseLiquidity(address,int24,int24,uint128,uint256,uint256)"
)
...
increase_liquidity_indexed_sig = (
    "IncreaseLiquidity(address,int24,int24,uint128,uint256,uint256)"
)
decrease_liquidity_indexed_sig = (
    "DecreaseLiquidity(address,int24,int24,uint128,uint256,uint256)"
)
collect_indexed_sig = "Collect(address,address,uint256,uint256)"

print(
    f"IncreaseLiquidity (indexed): {Web3.keccak(text=increase_liquidity_indexed_sig).hex()}"
)
print(
    f"DecreaseLiquidity (indexed): {Web3.keccak(text=decrease_liquidity_indexed_sig).hex()}"
)
