...
async def debug_page_structure():
    ...
    try:
        ...
        logger.info(
            "⏳ Please manually inspect the page and press Enter when ready to continue..."
        )
        ...
        for line in lines:
            ...
            if line and (
                ...
                or any(
                    word in line.lower()
                    for word in ["eth", "btc", "usdc", "usdt", "fox", "token", "coin"]
                )
                or any(char.isupper() for char in line[:3])  # Likely token symbols
            ):
