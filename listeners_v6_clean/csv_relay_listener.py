...
class CSVRelayListener:
    ...
    def __init__(self):
        ...
        self.logger.warning(
            "⚠️  CRITICAL: Current detection method is flawed - needs investigation"
        )
    ...
    def _init_csv_structure(self):
        ...
        transactions_path = os.path.join(
            self.transactions_dir, "relay_transactions.csv"
        )
        ...
        block_tracker_path = os.path.join(
            self.block_tracking_dir, "relay_block_tracker.csv"
        )
    ...
    def run_listener(
        ...
        self.logger.warning(
            "⚠️  CRITICAL: Relay listener has fundamental detection issues"
        )
        ...
        self.logger.info(
            f"🎯 Relay listener completed. Total transactions: {total_transactions}"
        )
